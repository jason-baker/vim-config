...
" Last Change:	$Date: 2009/06/06 02:48:15 $
...
" See http://real.metasyntax.net:2357/unix/vim.html for how to do this.
...
syn region  tclString		  start=+[^\\]"+ms=s+1  end=+"+ contains=tclSpecial,@tclVarRefC,tclEmbeddedStatement skip=+\\\\\|\\"+
